    ...
    <footer className="bg-white mt-10">
      <div className="max-w-7xl py-10 mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <a href="https://www.instagram.com/jobiffi">
              <img
                src="https://img.freepik.com/premium-psd/instagram-logo-social-media-icon_705838-13489.jpg"
                alt="instagram"
                className="h-7 w-7 object-contain"
              />
            </a>
        ...
        <div>
          <ul className="mt-3 space-y-2 text-gray-600">
            <a href="/" className="hover:text-blue-900 block">Home</a>
            <a href="/about-us" className="hover:text-blue-900 block">
              About us
            </a>
        ...
        <div>
          <ul className="mt-3 space-y-2 text-gray-600">
            ...
            <li className="hover:text-blue-900 cursor-pointer">Companies</li>
        ...
        <div>
          <ul className="mt-3 space-y-2 text-gray-600">
            ...
            <a href="/privacy-policy" target="_blank" className="hover:text-blue-900 block">
              Privacy Policy
            </a>

            <a href="/terms-conditions" target="_blank" className="hover:text-blue-900 block">
              Terms & Conditions
            </a>

            <a href="/fraud-alert" target="_blank" className="hover:text-blue-900 block">
              Fraud Alert
            </a>

            <a href="/trust-safety" target="_blank" className="hover:text-blue-900 block">
              Trust & Safety
            </a>
          </ul>
        </div>
        ...
        {/* Column 5 */}
        <div>
          <h6 className="font-semibold mt-3">Get the App today</h6>
      ...
      <div className="text-center mt-4 mb-4 text-gray-700">
        <h6 className="flex justify-center gap-2">
          All rights reserved <AiOutlineCopyright className="mt-1" /> 2026 Jobiffi (P) Ltd.
        </h6>
      </div>
    </footer>
  );
